      ...
      <div className="group relative">
        ...
        <div className="relative aspect-[3/4] overflow-hidden rounded-xl bg-charcoal/10">
          ...
          <motion.button
            ...
            className="absolute bottom-4 left-4 right-4 flex items-center justify-center gap-2 py-3 bg-white/95 backdrop-blur-sm rounded-lg text-charcoal font-medium shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white"
          >
            <Eye size={18} />
            Quick View
          </motion.button>
