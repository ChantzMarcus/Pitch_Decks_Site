...
- `WHY_FEATURES_WERE_DEMOTED.md` - Analysis of why features get lost
- `RECOMMENDATIONS.md` - Best practices to prevent feature loss
- `FEATURES_RESTORED_FINAL.md` - Examples of restored features
...
**Don't skip steps!** This checklist exists because features keep getting lost when steps are skipped.
